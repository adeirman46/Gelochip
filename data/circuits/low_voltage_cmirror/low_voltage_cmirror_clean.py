...
def add_lvcm_labels(lvcm_in: Component,
    ...
    # output 
    output1label = rectangle(layer=pdk.get_glayer("met2_pin"),size=(0.30,0.30),centered=True).copy()
    ...
    output2label = rectangle(layer=pdk.get_glayer("met2_pin"),size=(0.30,0.30),centered=True).copy()
...
def  low_voltage_cmirror(
    ...
    top_level << c_route(pdk, gate_1_via.ports["top_met_S"], gate_3_via.ports["top_met_S"], extension=(1.2*width[0]+1.4), cglayer='met2')
    top_level << c_route(pdk, gate_2_via.ports["top_met_S"], gate_4_via.ports["top_met_S"], extension=(1.2*width[0]-1.4), cglayer='met2')
    
    top_level << straight_route(pdk, fet_1_ref.ports["multiplier_0_source_W"], fet_1_ref.ports["tie_W_top_met_W"], glayer1='met1', width=0.24)
    top_level << straight_route(pdk, fet_3_ref.ports["multiplier_0_source_W"], fet_3_ref.ports["tie_W_top_met_W"], glayer1='met1', width=0.24)
