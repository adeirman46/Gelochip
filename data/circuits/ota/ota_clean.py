...
if os.path.exists(_GDS_CACHE):
    ...
    if _nl is not None:
        _nl_str = _nl.generate_netlist() if hasattr(_nl, 'generate_netlist') else str(_nl)
        if _nl_str and _nl_str.strip():
