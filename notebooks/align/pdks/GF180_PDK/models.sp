...
.model nfet_03v3 nmos l=1 w=1 nfin=1 nf=1 m=1 stack=1 parallel=1
.model pfet_03v3 pmos l=1 w=1 nfin=1 nf=1 m=1 stack=1 parallel=1
.model nfet_06v0 nmos l=1 w=1 nfin=1 nf=1 m=1 stack=1 parallel=1
.model pfet_06v0 pmos l=1 w=1 nfin=1 nf=1 m=1 stack=1 parallel=1
.model gf180mcu_fd_pr__nfet_03v3 nmos l=1 w=1 nfin=1 nf=1 m=1 stack=1 parallel=1
.model gf180mcu_fd_pr__pfet_03v3 pmos l=1 w=1 nfin=1 nf=1 m=1 stack=1 parallel=1
